...
const SERVICES = [
  { icon: "💰", title: "Ритуал богатства", desc: "Мощный ритуал на привлечение материального благополучия через взаимодействие с потусторонними силами. Раскрутка занимает полтора года. Работа на ментальном уровне.", price: "50 000 – 150 000 ₽", symbol: "🦅" },
  { icon: "💍", title: "Обряд на замужество", desc: "Ритуал для создания крепких семейных уз. Работа с демоническими силами на ментальном уровне. Процесс раскрутки — два года.", price: "50 000 ₽", symbol: "🐦‍⬛" },
  { icon: "🔮", title: "Глубокий расклад на ситуацию", desc: "Комплексная диагностика: любовь и отношения, финансы, проверка партнёра на верность, наличие порчи и сглаза. Таро, руны, энергетическое сканирование и анализ ауры. Получите полный отчёт с прогнозом и рекомендациями.", price: "6 000 ₽", symbol: "💀" },
  { icon: "🪄", title: "Энергетическая чистка", desc: "Устранение порчи, сглаза, негативных программ. Восстановление природной силы и энергетики.", price: "от 5 000 ₽", symbol: "🦅" },
  { icon: "🖤", title: "Приворот", desc: "Работаю только с серьёзными людьми. Индивидуальный подход к каждой ситуации. Результат обсуждается лично.", price: "индивидуально", symbol: "🐦‍⬛" },
  ...
  { icon: "⚰️", title: "Кладбищенская чистка", desc: "Снятие кладбищенской порчи, отворот, поворот, глубокая очистка. Работа с самыми тяжёлыми случаями.", price: "60 000 ₽", symbol: "💀" },
  { icon: "🛡️", title: "Создание амулетов", desc: "Мощные защитные амулеты. Каждый изготавливается индивидуально с личной привязкой.", price: "от 15 000 ₽", symbol: "🦅" },
  { icon: "🌀", title: "Практики души — вспоминай кем ты был", desc: "Глубокая работа с памятью прошлых воплощений. Узнай кем ты был, откуда твои таланты, страхи и незакрытые кармические задачи. Сессия открывает доступ к силе прошлых жизней.", price: "8 000 ₽", symbol: "🦅" },
];

const REVIEWS = [
  { name: "Клиентка", city: "", text: "Здравствуйте, хочу поделиться своим впечатлением после чистки у Ольги. Я около года не могла избавится от навязчивых мыслей о бывшем, хоть и сама его бросила и не хотела с ним быть. Прошло меньше недели после чистки и я о нем даже не вспоминаю. Действительно, шок. Спасибо Оле ❤️", stars: 5 },
  { name: "Клиентка", city: "", text: "Хочу выразить благодарность Оле за то что она неоднократно помогала мне выжить в этом мире, так получается что по жизни на меня было оказанное не одно магическое воздействие и Оля тот практик которому я доверяю, и благодарна за её отзывчивость, помощь в трудную минуту, за её реальные просмотры моей ситуации, а ситуации были разные, и во многом она поддерживала меня, давала совет, рекомендации и очень мне помогла, а в частности спасти мои отношения по судьбе, чётко увидела в чем причина и мощно очистила нашу пару от сильного воздействия которое по заказу недоброжелателей было сделано сильным колдуном, её чистки реально эффективные и дают результаты, поэтому знаю что Оле можно доверять и прислушиваться к её рекомендациям.", stars: 5 },
  { name: "Клиентка", city: "", text: "Олечка, ещё раз тебе спасибо! Твой ритуал с сердцем самый мощный 🔥🔥👍 муж на следующий день перестал общаться с любовницей! Ты сказала она будет делать гадости и это случилось, что ты говоришь так и происходит. Надо тебя слушать и доверять 🙏😘", stars: 5 },
  { name: "Клиентка", city: "", text: "Получила расклад. Девочка очень тёплая. Стало легче. Дала ритуал. Делаю. Сейчас буду второй накладывать сверху…", stars: 5 },
  { name: "Клиентка", city: "", text: "Обращалась к Ольге в начале года по изгнанию беса из мамы. Жизнь была невыносимой, мама была как не в себе, всем грубила, истерики на ровном месте, ходила разговаривала сама с собой. После изгнания беса мама поменялась на 180 градусов, стала нормальной, доброй, душевной! Благодарю Ольгу за такие чудеса, за невероятную помощь и поддержку в самых сложных ситуациях! 😇🙏❤️", stars: 5 },
  { name: "Клиентка", city: "", text: "Вечер добрый, Ольга очень приятный человек, открыла глаза, делает и дает нужные советы, очень рада то что попалась именно она, очень приятная женщина, благодарю её 🤗💋", stars: 5 },
  { name: "Клиентка", city: "", text: "Добрый вечер всем участникам группы, сегодня я хочу оставить отзыв о новой защите Ольги, которая помогла мне выстоять при мощном магическом нападении. Защита называется алмаз, работает и защищает сильно, поэтому если есть какая либо опасность чужего вторжения в личное пространство то очень рекомендую.", stars: 5 },
  { name: "Клиентка", city: "", text: "Оля, благодарю за сделанную чистку и установку защиты 🌺🌺🌺 Все работает 😍👍💃 После чистки в течение двух недель мои вражины, которых я подозревала в магических нападениях, начали получать обратку. В установке защиты я всю жизнь сомневалась и думала что приколотой булавки более чем достаточно ☺️ Но после установки твоей защиты я увидела реально рабочий эффект. Настроение улучшилось, я даже стала более весёлой и жизнерадостной. Благодарю тебя за твой проделанный труд ❤️❤️❤️", stars: 5 },
  { name: "Клиентка", city: "", text: "Я безмерно благодарю вас, Оля! Увидели всё! О чём я думала, но не могла осознать. Все смотрите глубоко ♥️ Внесли мне ясность что делать, над чем работать в отношениях с моим близнецовым партнёром 🩶 почему нет сил, работы и так далее. Буду обращаться ещё! Советую от души!", stars: 5 },
  { name: "Клиентка", city: "", text: "Оля, спасибо тебе большое! Все сказала как есть и даже больше! Спасибо за твой профессионализм и вовлечённый подход ❤️✨ Очень рада, что есть практики развитые всесторонне и могут просмотреть проблему объективно. Без воды, без лишних советов.", stars: 5 },
  { name: "Клиентка", city: "", text: "Добрый вечер всем участникам группы, я не в первый раз оставляю отзыв о работе мастера с большой буквы Ольге. Я очень восхищаюсь её стремлением к развитию, её силе, её мощи. В этот раз я в очередном плачевном состоянии обратилась к ней за помощью и она протянула руку помощи. Если бы не Оля — и это без всяких прикрас — я не знаю что бы со мной было. Она не в первый раз помогает мне в сложных ситуациях, и я с уважением и благодарностью рекомендую её как мощного, порядочного практика.", stars: 5 },
  { name: "Клиентка", city: "", text: "Обращалась к Оле 3 года назад, с тех пор регулярно сотрудничаем. ЭТО ПРОФЕССИОНАЛ с большой буквы, великая труженица и эмпат. Ни разу не пожалела, что меня взяли в работу и очистили меня, дом и малыша. Это стоит времени, сил и денег. Люблю тебя, Королева Чисток 👸🙏", stars: 5 },
  { name: "Клиентка", city: "", text: "Всех приветствую! Я уже давно с Олей и что она говорит — так и есть. Олю надо точно слушать, иначе последствия настигнут, как произошло со мной. Мне она говорила — никакого контакта с соперницей, а я не удержалась. Глубокая проработка на таро — я обалдела 🔥🔥🔥", stars: 5 },
  { name: "Клиентка", city: "", text: "Оля, в очередной раз хочу сказать большое спасибо за те советы, что ты даёшь мне лично. В отношениях и по работе всё налаживается с твоей помощью. Оленька, спасибо судьбе за то, что свела меня с тобой. Низкий поклон тебе за твою работу и советы ❤️❤️❤️", stars: 5 },
  { name: "Клиентка", city: "", text: "Всем привет! С этого года в нашей семье эти замечательные часы ❤️ Я начала находить подклады в доме — сегодня нашла мелочь на балконе на самом видном месте. Спасибо огромное Ольге, она подсказала что с этим делать! ❤️ Мы с мужем благодарны — начали раскрываться наши глаза. Ольга, всех благ тебе! ❤️", stars: 5 },
  { name: "Клиентка", city: "", text: "Отзыв о тотеме 🙏❤️ Вчера одела тотем — сразу почувствовала его мощь, мурашки по коже. Он показывал и убирал усталость. С утра отчётливо вижу энергетику в доме — это симптомы очищения. Выхожу на улицу — в душе гармония, чувствую деревья и природу. Оля, благодарю за тотем и за защиту! 😁❤️", stars: 5 },
  { name: "Клиентка", city: "", text: "Олечка, ты как всегда молодец! Желаю тебе и твоему дару процветания! Помогла мне улучшить свою жизнь — я сейчас счастливый человек! Обидчик мой получает по заслугам, как ты и говорила — всё будет постепенно, так оно и есть. Не раз обращалась за раскладом — всегда правда. Успехов тебе 🥰", stars: 5 },
  { name: "Клиентка", city: "", text: "Очень благодарна за расклад. На мой взгляд, это один из самых профессиональных тарологов, которого я встречала — всё было сказано очень чётко и по делу. Я получила ответ на вопрос, и отпали все заморочки. Действительно человек, который помогает! Рада, что обратилась именно к вам. Спасибо за ваш труд 🙏", stars: 5 },
  { name: "Клиентка", city: "", text: "Что бы мы делали без тебя, Ольга — наш талисман и оберег от всего чёрного и грязного, что шлют нам недруги. Очень хорошо, что ты нас чистишь и помогаешь в трудных жизненных ситуациях 🤗😘 Как невидимая рука ☺️ Очень здорово, что ты есть у меня ♥️", stars: 5 },
  { name: "Клиентка", city: "", text: "Хочу оставить отзыв в пользу этого человека. Всё в моей жизни было плохо, были большие проблемы с ребёнком — к счастью, сейчас с ним всё хорошо. Наладилась личная жизнь, есть человек на которого я могу положиться. Я счастлива, что когда-то обратилась к Ольге за помощью. Ни капельки не пожалела.", stars: 5 },
];
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div className={`transition-all duration-1000 delay-200 ${sectionVisible("about") ? "opacity-100 translate-x-0" : "opacity-0 translate-x-10"}`}>
              ...
              <div className="space-y-4 leading-relaxed" style={{ color: "rgba(212,175,55,0.55)", fontFamily: "'Cormorant Garamond', serif", fontSize: "1.05rem" }}>
                <p>Ольга — Чёрная Ведьма, практикующая магию на основе взаимодействия с потусторонними силами: бесами и демонами. Её ритуалы работают на ментальном уровне и направлены на достижение материального благополучия и семейного счастья.</p>
                <p>Специализация — сложные магические процедуры для тех, кто стремится к финансовому успеху и крепким семейным узам. Ольга берётся за случаи, с которыми другие не справляются.</p>
                <p>Работа ведётся индивидуально. Каждый ритуал — это серьёзный процесс, требующий времени и энергии. Результат приходит к тем, кто готов идти до конца.</p>
              </div>
              <div className="mt-8 grid grid-cols-2 gap-4">
                {[["Ритуалы богатства", "💰"], ["Обряды на замужество", "💍"], ["Работа с бесами", "🌑"], ["Ментальная магия", "🔮"]].map(([label, icon]) => (
        ...
        <div className="max-w-3xl mx-auto text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
            {[
              ...
              { icon: "MessageCircle", label: "Telegram / WhatsApp", value: "+7 (999) 982-56-61", href: "https://t.me/+79999825661" },
