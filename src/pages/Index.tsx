...
const SERVICES = [
  ...
  { icon: "🔱", title: "Защита Ахримана", desc: "Древняя и мощнейшая защита. Все враги будут вас бояться. Никто не осмелится причинить вам вред — ни в реальной жизни, ни на энергетическом уровне.", price: "23 000 ₽" },
];
