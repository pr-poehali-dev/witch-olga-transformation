...
const SERVICES = [
  ...
  { icon: "🔮", title: "Глубокий расклад на ситуацию", desc: "Комплексная диагностика: любовь и отношения, финансы, проверка партнёра на верность, наличие порчи и сглаза. Таро, руны, энергетическое сканирование и анализ ауры. Получите полный отчёт с прогнозом и рекомендациями.", price: "индивидуально", symbol: "💀" },
